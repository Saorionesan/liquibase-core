...
public class JdbcDatabaseSnapshot extends DatabaseSnapshot {
    ...
    public class CachingDatabaseMetaData {
        ...
        public List<CachedRow> getProcedures(final String catalogName, final String schemaName, final String procedure) throws SQLException, DatabaseException {
            return getResultSetCache("getProcedures").get(new ResultSetCache.SingleResultSetExtractor(database) {
                @Override // 快速获取SQL
                public List<CachedRow> fastFetchQuery() throws SQLException, DatabaseException {
